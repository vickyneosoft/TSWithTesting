...
describe('react native firebase auth implementation test', () => {
    ...
    it('should login with valid credentials', async () => {
        const res = await firebaseAuth.createUserWithEmailAndPassword('abc@gmail.com', '123456')
        expect(res).toBe('success')
    })

    it('should throw error on invalid email address', async () => {
        try {
            await firebaseAuth.createUserWithEmailAndPassword('abc', '123456')
        } catch (err: any) {
    ...
    it('should throw error on less then 6 characters password length', async () => {
        try {
            await firebaseAuth.createUserWithEmailAndPassword('abc@gmail.com', '123')
        } catch (err: any) {
    ...
    it('should throw error on greater then 15 characters password length', async () => {
        try {
            await firebaseAuth.createUserWithEmailAndPassword('abc@gmail.com', '123456789101010')
        } catch (err: any) {
...
describe('<LoginScreen /> rendering', () => {
    ...
    it('LoginScreen screen renders correctly', async () => {
        ...
        await act(async () => {
            emailInput?._fiber?.ref?.current?.setText('abc@gmail.com')
